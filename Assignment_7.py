...
class Ship:
    ...
    def update(self):
        ...
        if self.thrust:  
            ...
            self.vel[0] += point_at[0] / 10  
            self.vel[1] += point_at[1] / 10  
        else:  
...
def draw(canvas):
    ...
    canvas.draw_text(str(lives), (55, 64), 18, "White", "sans-serif")
 
    # draw score
    canvas.draw_text("Score", (WIDTH - 80, 40), 18, "White", "sans-serif")
    canvas.draw_text(str(score), (WIDTH - 60, 64), 18, "White", "sans-serif")
